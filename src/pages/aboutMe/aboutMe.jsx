...
function AboutMe({ isOpen, onClose, onCloseReady }) {
            ...
            <div className="about-content">
                ...
                <div className="profile-sections">
                    <div className="profile-section">
                        ...
                        <p>
                            I'm a BS Information Technology graduate in the
                            Philippines interested in front-end development,
                            visual design, and building interactive digital
                            experiences. I'm eager to explore new technologies
                    ...
                    <div className="profile-section">
                        ...
                        <div className="interest-list">
                            <span className="hobby illust">
                                Digital Illustration
                            </span>

                            <span className="hobby games">
                                Gaming
                            </span>

                            <span className="hobby crochet">
                                Crocheting
                            </span>
                        </div>
                    </div>
